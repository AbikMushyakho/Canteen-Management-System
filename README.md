# Canteen Management System By Abik Mushyakho
...
```
cd existing_repo
git remote add origin https://gitlab.com/AbikMushyakho/final_project_infodev.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/AbikMushyakho/final_project_infodev/-/settings/integrations)
